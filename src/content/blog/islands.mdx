...
import "../../assets/demo-component.scss";
...
are _only_ rendered server side, and only the resulting HTML/CSS is sent down to
...
For the times when a component _does_ have interactivity, you can add a
[client directive](https://docs.astro.build/en/reference/directives-reference/#client-directives)
to instruct Astro to include the JavaScript. This creates _islands_ of interactive
...
<small>
  [View Vue Component
  Code](https://github.com/briandadams85/bdadamsdotcom/blob/main/src/components/Blog/Islands/VueExperiment.vue)
</small>
...
<small>
  ...
  Code](https://github.com/briandadams85/bdadamsdotcom/blob/main/src/components/Blog/Islands/react/ReactExperiment.jsx)
</small>
...
<small>
  [View Lit Component
  Code](https://github.com/briandadams85/bdadamsdotcom/blob/main/src/components/Blog/Islands/LitExperiment.js)
</small>
...
<small>
  ...
  Code](https://github.com/briandadams85/bdadamsdotcom/blob/main/src/components/Blog/Islands/preact/PreactExperiment.jsx)
</small>

<SolidComponent client:visible data={testData} />

<small>
  [View Solid Component
  Code](https://github.com/briandadams85/bdadamsdotcom/blob/main/src/components/Blog/Islands/solid/SolidExperiment.jsx)
</small>
...
<small>
  ...
  Code](https://github.com/briandadams85/bdadamsdotcom/blob/main/src/components/Blog/Islands/SvelteExperiment.svelte)
</small>

<AlpineComponent data={testData} />

<small>
  [View Alpine Component
  Code](https://github.com/briandadams85/bdadamsdotcom/blob/main/src/components/Blog/Islands/AlpineExperiment.astro)
</small>

<Embed url="https://www.youtube.com/embed/erG5rgNYSdk?si=mJHzUT2-rR5xL-tx" />
